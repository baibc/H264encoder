 ...
 * init device
 */
int init(int width, int height, int rate)
{
...
int dqbuf(int fps)
{
		...
		if(fps ==60){
				...
				}else if(bcount==2 || bcount==4 || bcount==7 || bcount==9 || bcount==11){
